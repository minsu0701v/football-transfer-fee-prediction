...
def create_xgboost_pipeline() -> Pipeline:
    model = XGBRegressor(
        ...
        n_estimators=1000,
        learning_rate=0.011767723769228444,
        max_depth=2,
        min_child_weight=6,
        subsample=0.9992092488368376,
        colsample_bytree=0.9038089871266605,
        reg_alpha=0.7049293768304302,
        reg_lambda=2.0685175133857916,
