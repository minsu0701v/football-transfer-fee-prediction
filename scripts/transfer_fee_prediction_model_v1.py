...
TRAINING_FILE = PROJECT_ROOT / "data" / "processed" / "training_dataset.csv"

MODEL_DIR = PROJECT_ROOT / "models"
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "model_v1"

MODEL_FILE = MODEL_DIR / "transfer_fee_model_v1.joblib"
METADATA_FILE = MODEL_DIR / "transfer_fee_model_v1_metadata.json"

EVALUATION_FILE = OUTPUT_DIR / "model_v1_evaluation.csv"
PREDICTION_FILE = OUTPUT_DIR / "model_v1_test_predictions.csv"
FEATURE_IMPORTANCE_FILE = OUTPUT_DIR / "model_v1_feature_importance.csv"
...
def save_metadata(
    ...
    metadata = {
        "model_name": "transfer_fee_model_v1",
        ...
        "value_at_transfer_included": True,
...
def main() -> None:
    ...
    print_section("Transfer Fee Prediction Model V1")
    ...
    print()
    print(
        "다음 단계: 저장된 joblib 모델을 FastAPI에서 "
        "불러와 /predict 엔드포인트에 연결"
    )
